...
% Last Modified by GUIDE v2.5 27-Feb-2021 18:00:29
...
% --- Executes on button press in Corr_current.
function Corr_current_Callback(hObject, eventdata, handles)
% hObject    handle to Corr_current (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
try
    ...
    %Save current trace as the userdata of Plot_correlation
    hObject.UserData.curTrace = ...
        handles.Regional_stat.UserData.regional_stat.curTrace;
    
    plotCorrObj.curMovie = handles.output.UserData.curMovie;
    plotCorrObj.reg_flag = handles.Regress_flag.Value;
    plotCorrObj.filename = handles.Load_movie.UserData.filename;
    plotCorrObj.curTrace = hObject.UserData.curTrace;
    plotCorrObj.curPos = [NaN, NaN];
    ...
    msgbox('Error calculating correlations!')
end
